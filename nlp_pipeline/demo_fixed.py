"""
RevuIQ NLP Pipeline Demo (macOS Compatible)
Complete end-to-end demonstration with threading fix
"""

import os
# FIX: Set environment variables BEFORE importing torch/transformers
...
def main():
    ...
    try:
        ...
        print("\nTroubleshooting:")
        print("1. Make sure you have internet connection (models download on first run)")
        print("2. Try: pip install --upgrade transformers torch")
        print("3. Check disk space (models need ~2GB)")
        return
    ...
    if not results:
        print("\n❌ No reviews were successfully analyzed")
        return
